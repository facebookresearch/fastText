...
productquantizer.o: src/productquantizer.cc src/productquantizer.h src/utils.h src/real.h src/vector.h
...
quantmatrix.o: src/quantmatrix.cc src/quantmatrix.h src/utils.h src/matrix.h src/densematrix.h src/productquantizer.h src/real.h src/vector.h
	$(CXX) $(CXXFLAGS) -c src/quantmatrix.cc

vector.o: src/vector.cc src/vector.h src/utils.h src/matrix.h src/real.h
	$(CXX) $(CXXFLAGS) -c src/vector.cc

model.o: src/model.cc src/model.h src/args.h src/matrix.h src/utils.h src/loss.h src/real.h src/vector.h
