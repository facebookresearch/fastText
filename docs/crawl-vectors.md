...
In order to download with command line or from python code, you must have installed the python package as [described here](https://github.com/facebookresearch/fastText/blob/master/docs/support.md#building-fasttext-python-module).
...
In order to use that feature, you must have installed the python package as [described here](https://github.com/facebookresearch/fastText/blob/master/docs/support.md#building-fasttext-python-module).
