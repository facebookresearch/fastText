...
class FastText {
  ...
  public:
    ...
    void supervised(Model&, const std::vector<int32_t>&,
                    const std::vector<int32_t>&, double&, int32_t&);
    void cbow(Model&, const std::vector<int32_t>&, double&, int32_t&);
    void skipgram(Model&, const std::vector<int32_t>&, double&, int32_t&);
